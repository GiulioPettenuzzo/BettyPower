...
import com.renard.betty.analytics.Analytics;
import com.renard.betty.analytics.AnalyticsFactory;
...
public class TextFairyApplication extends Application {
    ...
    public static boolean isRelease() {
        return com.renard.betty.BuildConfig.FLAVOR.contains("playstore");
    }
